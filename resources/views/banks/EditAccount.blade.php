    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <form method="post" action="{{ route('bank_account_update', ['id' => $bankAccount->id]) }}">
                        @csrf
                        @method('PUT')
                        @error("bank_name")
                        ...
                        <div class="mx-auto max-w-lg">
                            <div class="py-1">
                                ...
                                focus:border-gray-600 focus:outline-none" name="bank_name" value="{{ $bankAccount->bank_name }}">
                            </div>
                            <div class="py-1 flex space-x-2"> <!-- Adicionado classe flex e space-x-2 para alinhar horizontalmente -->
                                <div class="w-1/2"> <!-- Dividir o espaço em duas partes iguais -->
                                    ...
                                    <input placeholder="" type="text" class="text-md block px-3 py-2 rounded-lg w-full bg-white border-2
                                    border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white
                                    focus:border-gray-600 focus:outline-none" name="branch_number" value="{{ $bankAccount->branch_number }}">
                                </div>
                                <div class="w-1/2"> <!-- Dividir o espaço em duas partes iguais -->
                                    <span class="px-1 text-sm text-white">Conta</span>
                                    <input placeholder="" type="text" class="text-md block px-3 py-2 rounded-lg w-full bg-white border-2
                                    border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white
                                    focus:border-gray-600 focus:outline-none" name="account_number" value="{{ $bankAccount->account_number }}">
                                </div>
                            </div>
